...
L5 <- tibble(Yrs, Data) %>% ggplot(aes(Yrs, Data)) + geom_point(shape = "*", color = "red", size = 5) + ylim(0,9000) + geom_line(aes(Years, Pred), data = Predictions) + ggtitle('Lag 5') + geom_line(aes(Years, Pred), data = Predictions2, lty = 2)
...
L3 <- tibble(Yrs,Data) %>% ggplot(aes(Yrs, Data)) + geom_point(shape = "*", color = "red", size = 5) + ylim(0,9000) + geom_line(aes(Years, Pred), data = Predictions) + ggtitle('Lag 3') + geom_line(aes(Years, Pred), data = Predictions2, lty = 2)
...
L0 <- tibble(Yrs, Data) %>% ggplot(aes(Yrs, Data)) + geom_point(shape = "*", color = "red", size = 5) + ylim(0,9000) + geom_line(aes(Years, Pred), data = Predictions) + ggtitle('Lag 0') + geom_line(aes(Years, Pred), data = Predictions2, lty = 2)
